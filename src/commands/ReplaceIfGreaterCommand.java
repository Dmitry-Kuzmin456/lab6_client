...
public class ReplaceIfGreaterCommand implements Command, ValidatableArguments {
    ...
    public void execute(Connector connector, String[] args) throws IllegalArgumentException, SocketTimeoutException {
        ...
        try{
            ...
            byte[] request = RequestGenerator.generateWithCity("replace_if_greater", city);
    ...
    public String description() {
        return "replace element if it greater";
    }
